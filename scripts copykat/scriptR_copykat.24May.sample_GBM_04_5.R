...
output_dir <- paste0(illness, ".copykat.output_25may_rds", sep="")
...
# Values that are log-transformed and normalized ???? (Chat) or raw (Claude)
...
#####################################################################
#####################################################################
# copyKat introduces . in the name of the cells (it needs to be corrected it !)
#####################################################################
#####################################################################
...
seg_file <- file.path(output_dir, "copykat_CNA_results.seg")
...
#####################################################################
#####################################################################
########################## a customized version of the visual display
#####################################################################
#####################################################################
